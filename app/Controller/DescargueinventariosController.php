 ...
 */
	public function delete() {
        ...
        public function ajaxOtenerProductoDescargue(){
            ...
            $arrProductos = $this->Cargueinventario->obtenerProductoStock($productoId);
            $cantidadProd = '1';
        ...
        public function actualizarCantidadDescargue(){
            ...
            if(!$this->validarDescargueInventario($descargueId, $cantidad)){
                ...
                $arrProductos = $this->Cargueinventario->obtenerProductoStock($descargueActual['Descargueinventario']['producto_id']);
