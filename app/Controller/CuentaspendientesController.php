 ...
 */
	public function index() {
            ...
            for($i = 0; $i < count($cuentaspendientes); $i++){
                ...
                $costoTotal += ($cuentaspendientes[$i]['Cuentaspendiente']['costoproducto'] * $cuentaspendientes[$i]['Cuentaspendiente']['cantidad']);
                ...
                if($diff <= '0'){
                    ...
                    $costoVencido += ($cuentaspendientes[$i]['Cuentaspendiente']['costoproducto'] * $cuentaspendientes[$i]['Cuentaspendiente']['cantidad']);
                }else{
                    $cuentaspendientes[$i]['Cuentaspendiente']['color'] = 'success';
                    $cuentaspendientes[$i]['Cuentaspendiente']['diasvencido'] = $diff;
                    $costoVigente += ($cuentaspendientes[$i]['Cuentaspendiente']['costoproducto'] * $cuentaspendientes[$i]['Cuentaspendiente']['cantidad']);
                }
            }
