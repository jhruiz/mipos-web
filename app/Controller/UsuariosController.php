...
class UsuariosController extends AppController {
                ...
                if(count($arrUsuarios) < $cantidadLicencias){
                    if(isset($arrEstadoLic['LicenciasEmpresa']) && $arrEstadoLic['LicenciasEmpresa']['estado_id'] == '1'){
                        if ($estado == '1') {
                            ...
                            //}else{
                            //    $this->Session->setFlash(__('El usuario ya se encuentra logueado, no puede loguearse de nuevo.'));
                            //}                      
                        } else {
    ...
    public function paginainicio() {
        ...
        $arrMenusPerfil = $this->CloudmenusPerfile->obtenerMenusPorPerfilId($perfilId);
        ...
        $this->set(compact('arrMenusPerfil', 'urlPublica', 'urlImagMenu'));
