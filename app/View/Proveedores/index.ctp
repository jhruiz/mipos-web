...
<div class="proveedores index">
            ...
            <?php echo $this->Form->create('Proveedores',array('action'=>'search','method'=>'post'));?>
            <legend><h2 class="bg-primary"><b><?php echo __('Buscar Proveedores'); ?></b></h2></legend> 
	...
	<legend><h2 class="bg-primary"><b><?php echo __('Proveedores'); ?></b></h2></legend>
