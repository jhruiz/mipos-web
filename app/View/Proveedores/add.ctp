...
<?php echo $this->Form->create('Proveedore'); ?>
	<fieldset>
		<legend><h2 class="bg-primary"><b><?php echo __('Agregar Proveedor'); ?></b></h2></legend>
                ...
                <div class="form-group form-inline"> 
                    <?php echo $this->Form->input('diascredito', array('label' => 'Días de Crédito', 'class' => 'form-control number', 'placeholder' => 'Días de Credito')); ?>                   
                </div>
