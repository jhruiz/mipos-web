...
<div class="cuentasclientes index">
	<legend><h2 class="bg-primary"><b><?php echo __('Cuentas por Cobrar'); ?></b></h2></legend>    
        ...
        <div class="table-responsive">
            <div class="container-fluid">         
                ...
                <tr class="<?php echo $cuentascliente['Cuentascliente']['color'];?>">
                        ...
                        <td>
                            <?php if ($cuentascliente['Factura']['consecutivodian'] != ""){?>
                                <?php echo $this->Html->link($cuentascliente['Factura']['consecutivodian'], array('controller' => 'facturas', 'action' => 'view', $cuentascliente['Factura']['id'])); ?>
                            <?php } else {?>
                                <?php echo $this->Html->link($cuentascliente['Factura']['codigo'], array('controller' => 'facturas', 'action' => 'view', $cuentascliente['Factura']['id'])); ?>
                            <?php } ?>
                        </td>
                        <td><?php echo h($cuentascliente['Cuentascliente']['created']); ?>&nbsp;</td>
                        <td><?php echo h($cuentascliente['Cliente']['diascredito']); ?>&nbsp;</td>
