...
<div class="productos index">    
            ...
            <?php echo $this->Form->create('Productos',array('action'=>'search','method'=>'post'));?>
            <legend><h2 class="bg-primary"><b><?php echo __('Buscar Productos'); ?></b></h2></legend> 
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group ">  
                        ...
                        <input name="marca" id="marca" class="form-control" placeholder="Marca del Producto" type="text">
                    </div>             
                </div>                             
        </div>        
        <div class="row">
        ...
        <legend><h2 class="bg-primary"><b><?php echo __('Productos'); ?></b></h2></legend>            
        ...
        <div class="table-responsive">
			...
			<th><?php echo $this->Paginator->sort('Costo Promedio'); ?></th>
	...
	<tr>
		...
		<td><?php echo h("$" . number_format($producto['Producto']['costopromedio'],2)); ?>&nbsp;</td>
		<td class="actions">
