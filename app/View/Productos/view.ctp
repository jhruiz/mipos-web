<?php $this->layout='inicio'; ?>
    <div class="productos view">
        <legend><h2 class="bg-primary"><b><?php echo __('Producto'); ?></b></h2></legend>
            ...
            <section class="main row">                            
                ...
                <div class="col-md-4">
                    <dl>
                        ...
                        <dt class="text-info"><?php echo __('Costo Promedio'); ?></dt>
                            <dd>
                                    <?php echo h("$" . number_format($producto['Producto']['costopromedio'],2)); ?>
                                    &nbsp;
                            </dd><br>
