...
<div class="documentos index">
            ...
            <?php echo $this->Form->create('Documentos',array('action'=>'search','method'=>'post'));?>
            <legend><h2 class="bg-primary"><b><?php echo __('Buscar Documentos'); ?></b></h2></legend> 
	...
	<legend><h2 class="bg-primary"><b><?php echo __('Documentos'); ?></b></h2></legend>
