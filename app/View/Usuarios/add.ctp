...
<?php echo $this->Form->create('Usuario', array('type' => 'file', 'class' => 'form-horizontal')); ?>
	<fieldset>
		...
		<?php echo $this->Form->input('menuvert', array('type' => 'hidden', 'value' => '25', 'id' => 'menuvert'))?>
                ...
                <div class="form-group form-inline">
                    <?php echo $this->Form->input('password', array('class' => 'form-control', 'placeholder' => 'Contraseña del Usuario')); ?>
                </div>	                
                <div class="form-group form-inline">
                    <?php echo $this->Form->input(null, array('label' => 'Repetir Password', 'id' => 'repetirPass', 'type' => 'password', 'class' => 'form-control', 'placeholder' => 'Repetir Contraseña')); ?>
                </div>	                
