...
<div class="cargueinventarios form">
	<fieldset>
		<legend><h2 class="bg-primary"><b><?php echo __('Selección de Productos'); ?></b></h2></legend>
                                    ...
                                    <div class="row">
                                        <?php for($k; $k < $contador; $k++){?>
                                            <?php if (isset($productos[$k])){?>
                                                <div class="col-xs-6 col-sm-6 col-md-2 color1">                                                
                                                    <div id="dv_<?php echo $productos[$k]['Producto']['id'];?>" class="panel panel-default">
                                                        <div class="panel-heading">                                                        
                                                            <img src="<?php echo $urlImg . $productos[$k]['Producto']['empresa_id'] . '/' . $productos[$k]['Producto']['imagen'];?>" class="img-responsive img-rounded center-block" style="max-width: 150px; max-height: 150px" />                                                       
                                                        </div>  
