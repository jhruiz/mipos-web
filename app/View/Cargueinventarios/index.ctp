...
<div class="cargueinventarios index">
            ...
            <?php echo $this->Form->create('Cargueinventario',array('action'=>'search','method'=>'post'));?>
            <legend><h2 class="bg-primary"><b><?php echo __('Buscar Inventario'); ?></b></h2></legend>      
    ...
    <legend><h2 class="bg-primary"><b><?php echo __('Inventario'); ?></b></h2></legend>
	...
	<div class="actions">
        ...
        <div class="table-responsive">
            <div class="container">        
                ...
                <?php foreach ($cargueinventarios as $cargueinventario): ?>
		...
		<td class="actions">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-2">                
                            <dl>
                                <dt class="text-right text-success"><?php echo h($totalUnidades)?></dt>
