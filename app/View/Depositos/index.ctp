...
<div class="depositos index">
            ...
            <?php echo $this->Form->create('Depositos',array('action'=>'search','method'=>'post'));?>
            <legend><h2 class="bg-primary"><b><?php echo __('Buscar Depósitos'); ?></b></h2></legend>   
	...
	<legend><h2 class="bg-primary"><b><?php echo __('Depósitos'); ?></b></h2></legend>
