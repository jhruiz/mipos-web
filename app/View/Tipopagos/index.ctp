...
<div class="tipopagos index">
	<legend><h2 class="bg-primary"><b><?php echo __('Tipo de Pago'); ?></b></h2></legend>
        <div class="table-responsive">
            <div class="container">        
                <table cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover table-condensed">
                <tr>
                                <th><?php echo $this->Paginator->sort('descripcion', 'Nombre Tipo de Pago'); ?></th>
                                <th><?php echo $this->Paginator->sort('contabilizar'); ?></th>
                ...
                <tr>
                        ...
                        <td><?php if($tipopago['Tipopago']['contabilizar'] == '1'){echo "SI";}else{echo "NO";} ?>&nbsp;</td>
                        <td>
