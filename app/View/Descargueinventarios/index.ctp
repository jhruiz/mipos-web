...
<div class="descargueinventarios index">
	<legend><h2 class="bg-primary"><b><?php echo __('Descargue de Inventario'); ?></b></h2></legend>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">  
                            <label>Producto</label><br>               
                                ...
                                <?php echo $this->Form->input('buscarproducto', array('label' => false, 'class' => 'form-control', 'autocomplete' => 'off', 'placeholder' => 'Ingresar Nombre o Código del Producto', 'onkeyup' => 'fnObtenerDatosProducto(event);')); ?>
