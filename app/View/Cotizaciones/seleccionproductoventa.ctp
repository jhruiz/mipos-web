...
?>
<legend><center><h4><?php echo __('Información del Productos'); ?></h4></center></legend><br><br>           
<section class="main row">
    ...
    <div class="col-md-6">        
        ...
        <div class="form-group form-inline"> 
            ...
            <div class="input-group">
                <span class="input-group-addon">$</span>                    
                <?php echo $this->Form->input('precioventa', array('label' => '', 'class' => 'form-control numericPrice', 'placeholder' => 'Precio de Venta', 'value' => $arrProducto['Cargueinventario']['precioventa'], 'onblur' => 'validarPrecioMinimo();')); ?>
            </div>
        </div> 
        <legend>&nbsp;</legend>
        <b>Impuestos</b><br>
...
<div class="container-fluid">
    <button  id="btn_guardarEst" class="btn btn-primary center-block" onclick="agregarProductoCotizacion()">Agregar</button>
</div>
